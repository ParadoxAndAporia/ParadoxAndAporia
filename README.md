...
|----------------|-----------------|-----|
|Проект 1 Дашборд распределения премий (Для корректного отображения следует открывать на полном экране) [tableau](https://public.tableau.com/app/profile/emil.rakhimov/viz/_17011378241180/sheet9) |BI, tableau|
